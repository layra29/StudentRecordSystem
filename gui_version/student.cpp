...
#include <sstream> // make sure this is at the top of student.cpp if not already

std::string StudentList::displayStudentsToString() {
...
void StudentList::addStudentDirect(Student* student) {
    student->next = head;
    head = student;
}
